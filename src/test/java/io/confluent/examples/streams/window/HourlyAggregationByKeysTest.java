...
//
//
//public class HourlyAggregationByKeysTest {
//
//    Logger LOGGER = Logger.getLogger(HourlyAggregationByKeysTest.class.getName());
...
//
//    @Test
//    public void shouldSumNumbersByHoursByKeys() {
//        final List<Metric> inputValues = Arrays.asList(
//
//                new Metric("key1", 1, ZonedDateTime.of(2019, 1, 1, 15, 19, 0, 0, zone)),
//                new Metric("key1",2, ZonedDateTime.of(2019, 1, 1, 15, 20, 0, 0, zone)),
//                new Metric("key1",3, ZonedDateTime.of(2019, 1, 1, 15, 21, 0, 0, zone)),
//
//                new Metric("key2",4, ZonedDateTime.of(2019, 1, 1, 16, 29, 0, 0, zone)),
//                new Metric("key2",5, ZonedDateTime.of(2019, 1, 1, 16, 30, 0, 0, zone)),
//                new Metric("key2",6, ZonedDateTime.of(2019, 1, 1, 16, 31, 0, 0, zone)),
//
//                new Metric("key3",7, ZonedDateTime.of(2019, 1, 1, 17, 39, 0, 0, zone)),
//                new Metric("key3",8, ZonedDateTime.of(2019, 1, 1, 17, 40, 0, 0, zone)),
//                new Metric("key3",9, ZonedDateTime.of(2019, 1, 1, 17, 41, 0, 0, zone)),
//
//                new Metric("key4",1, ZonedDateTime.of(2019, 1, 1, 18, 49, 0, 0, zone)),
//                new Metric("key4",2, ZonedDateTime.of(2019, 1, 1, 18, 50, 0, 0, zone)),
//                new Metric("key4",7, ZonedDateTime.of(2019, 1, 1, 18, 51, 0, 0, zone))
...
//    }
//
//    private void verifyByHour(final List<Metric> inputValues, final List<ExpectedResult> expectedValues, final ZoneId zoneId) {
//
...
//                .map(new KeyValueMapper<String, Integer, KeyValue<?, ?>>() {
//                    @Override
//                    public KeyValue<?, ?> apply(String s, Integer integer) {
//                        return new KeyValue<>(s,integer);
//                    }
//                })
////                .selectKey(Grouped.with(Serdes.String())
//                .groupByKey()
//                .windowedBy(new HourlyTimeWindows(zoneId, windowStartHour, Duration.ofMinutes(30)))
//                // A simple sum of value
//                .aggregate((v1, v2) -> v1 + v2, Materialized.with(Serdes.Integer(), Serdes.Integer()))
...
//
//        public Metric(final String metricKey, final Integer value, final ZonedDateTime timestamp) {
...
//    }
//
//    private void injectFakeData(final List<Metric> inputValues, final TopologyTestDriver testDriver) {
...
//    */
//    private Metric dummyEventToForceSuppression() {
//        return new Metric("DUMMY",7, ZonedDateTime.now());
//    }
//}
