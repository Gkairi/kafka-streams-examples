...
public class HourlyTimeWindows extends Windows<TimeWindow> {

    Logger LOGGER = Logger.getLogger(HourlyTimeWindows.class.getName());
    private final ZoneId zoneId;
    private final long grace;
    private final int startHour;

    public HourlyTimeWindows(final ZoneId zoneId, final int startHour, final Duration grace) {
        this.zoneId = zoneId;
    ...
    public Map<Long, TimeWindow> windowsFor(final long timestamp) {
        ...
        final ZonedDateTime startTime = zonedDateTime.truncatedTo(ChronoUnit.DAYS).withHour(zonedDateTime.getHour()); // >= startHour ? zonedDateTime.truncatedTo(ChronoUnit.DAYS).withHour(startHour) : zonedDateTime.truncatedTo(ChronoUnit.DAYS).withHour(startHour);
        ...
        LOGGER.info("Input Time ==>  "+zonedDateTime+ " ; \\t Mapped Window {Start Time:" + startTime + " , End Time: " + endTime + " }" );
        return windows;
    }
